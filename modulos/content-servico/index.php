...
<section class="py-5">
    <div class="px-4 px-lg-0 container mx-auto py-5">
        ...
        <div class="text-0 text-center">
            ...
            <div class="mx-auto card-text-servico mb-5">
                <h4 class="text-center mb-2 fw-bold">Securitização de recebíveis</h4>
                <p>Transformamos ativos financeiros em capital imediato com segurança jurídica, agilidade operacional e soluções estruturadas sob medida para o seu perfil.</p>
            </div>

            <div class="mx-auto card-text-servico mb-5">
                <h4 class="text-center mb-2 fw-bold">Estruturação de operações</h4>
                <p>Desenvolvemos operações personalizadas para conectar originadores e investidores, com foco em rentabilidade, transparência e solidez no mercado de capitais.</p>
            </div>

            <div class="mx-auto card-text-servico">
                <h4 class="text-center mb-2 fw-bold">Gestão de riscos e compliance</h4>
                <p>Oferecemos suporte técnico completo com foco em governança, conformidade regulatória e estratégias eficientes de mitigação de riscos financeiros.</p>
            </div>
        </div>
