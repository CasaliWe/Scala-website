<section class="pt-4 pb-2 border-top-site bg-0">
    <div class="container mx-auto py-4">
        <div class="row">
            ...
            <div class="mb-5 mb-lg-0 col-12 col-lg-2 d-flex flex-column text-center text-lg-start">
                <h4 class="mb-4 text-white fw-semibold">Navegação</h4>

                <a class="mb-3 text-white" href="<?= $base_url; ?>index.php">Início</a>
                <a class="mb-3 text-white" href="<?= $base_url; ?>empresa.php">Empresa</a>
                <a class="mb-3 text-white" href="<?= $base_url; ?>contato.php">Contato</a>
            </div>
            <div class="mb-5 mb-lg-0 col-12 col-lg-2 d-flex flex-column text-center text-lg-start">
