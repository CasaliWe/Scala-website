<section class="py-5" style="background-color: #EFEFEF;">
    <div class="text-center container mx-auto px-4 px-lg-0">
        <img style="width: 60px;" src='<?= $base_url ?>assets/imagens/site/icone-scala.png'>

        <!-- conteúdo -->
        <div class="mt-5 text-center text-0">
            <p class="mb-3 fs-5">Quem somos e no que acreditamos</p>
            <h1 class="text-0 fw-bold display-5">Soluções financeiras seguras, com transparência e responsabilidade.</h1>
